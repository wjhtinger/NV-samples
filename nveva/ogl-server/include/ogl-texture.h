...
extern void oglTextureDelete(ogl_texture_t *texture);
extern GLint oglTextureGenerate(ogl_texture_t *texture);
extern GLint oglTextureFromImage(ogl_texture_t *texture, ogl_image_t *img);
extern GLint oglTextureFromStream(ogl_texture_t *texture,
				  EGLDisplay dpy, EGLStreamKHR str);
extern GLint oglTextureFromFile(ogl_texture_t *texture, const char *path);

#ifdef __cplusplus
	}
#endif

#endif	/* __OGL_TEXTURE_H__ */
