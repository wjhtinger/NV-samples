...
#ifndef __OGL_IMAGE_PNG_H__
#define __OGL_IMAGE_PNG_H__
...
#ifdef HAVE_LIBPNG
extern GLvoid *oglImageFromPNG(ogl_image_t *im, const char *path);
#else
static inline GLvoid *oglImageFromPNG(ogl_image_t *im, const char *path)
{
	return NULL;
}
#endif
