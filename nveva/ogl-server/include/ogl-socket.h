...
#ifndef __OGL_SOCKET_H__
#define __OGL_SOCKET_H__

#ifdef __cplusplus
	extern "C" {
#endif

extern int oglCreateSocket(void);
extern int oglBindSocket(int sock, unsigned port);
extern int oglBindToDev(int sock, const char *name);
extern int oglSockTCPDelay(int sock, int disable);
extern int oglListenSocket(int sock);
extern int oglCreateAcceptSocket(int sock);
extern int oglConnectSocket(int sock, const char *ip, unsigned port);
extern int oglSendStringSocket(int sock, char *buf);
extern int oglReceiveStringSocket(int sock, char *buf, unsigned len);

#ifdef __cplusplus
	}
#endif

#endif	/* __OGL_SOCKET_H__ */
