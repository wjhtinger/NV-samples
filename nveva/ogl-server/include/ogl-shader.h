...
extern GLint oglCompileShader(GLuint shaderID, char** log);
extern GLint oglLinkProgram(GLuint programID, GLuint *shaderID, int num,
			    char** log);
extern GLuint oglCreateProgram(const char *vss, const char *fss,
