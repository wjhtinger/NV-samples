...
#ifndef __OGL_WAYLAND_H__
#define __OGL_WAYLAND_H__
...
extern int waylandDisplayInit(struct wl_display **wlDisplay);
extern EGLSurface waylandCreateSurface(struct wl_display *wlDisplay, EGLConfig cfg,
