...
//------------------------------------------------------------------------------
//! \file nvcameracoding.h
//! \brief Interface to camera coding
//------------------------------------------------------------------------------

#ifndef _INCLUDED_NVCAMERACODING_H_
#define _INCLUDED_NVCAMERACODING_H_

#include "nvevainterface.h"
#include "nvcapturevideosink.h"

typedef void CameraCoding;

typedef struct _CameraCodingParameters {
    // Defines mapping of src to dest
    NvCaptureSinkCSIParam       oCSIParam;
    NvCaptureSinkRenderParam    oRenderParam;

    NvRectangle m_srcRect;
    NvRectangle m_dstRect;
} CameraCodingParameters;
...
#endif /* _INCLUDED_NVCAMERACODING_H_ */
