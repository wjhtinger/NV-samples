...
#define ISC_AR0231_T1_EXPOSURE_MASK     (1 << 0)
#define ISC_AR0231_T2_EXPOSURE_MASK     (1 << 1)
#define ISC_AR0231_T3_EXPOSURE_MASK     (1 << 2)
...
typedef enum {
    ...
    ISC_CONFIG_AR0231_DVP_RAW12_COMP_1920X1208_20FPS,
    ISC_CONFIG_AR0231_ENABLE_STREAMING,
}ConfigSetsAR0231;

typedef enum {
    ISC_CONFIG_AR0231_1920X1208 = 0,
    ISC_CONFIG_AR0231_1920X1008,
    ISC_CONFIG_AR0231_NUM_RESOLUTION,
} ConfigResolutionAR0231;

typedef enum {
    ISC_CONFIG_AR0231_1920X1208_30FPS = 0,
    ISC_CONFIG_AR0231_1920X1208_20FPS,
    ISC_CONFIG_AR0231_1920X1008_36FPS,
    ISC_CONFIG_AR0231_NUM_FORMAT,
} ConfigFormatAR0231;
