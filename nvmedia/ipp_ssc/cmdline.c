...
void PrintUsage(void)
{
    ...
    LOG_MSG("Usage: nvmipp_ssc -cf [file] -d [n]\n");
    ...
    LOG_MSG("                   Default: 0\n");
    LOG_MSG("-f [filename]      Save raw frames to file\n");
    LOG_MSG("-w [n]             Set display window ID [0-2]. Default: 0\n");
    LOG_MSG("-z [n]             Set display window depth [0-255]. Default: 0\n");
