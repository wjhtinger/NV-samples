    ...
    TestArgs *testArgs)
{
    ...
    interopCtx->aggregateFlag = ippCtx->aggregateFlag;
    ...
    interopCtx->inputSurfAttributes = ippCtx->inputSurfAttributes;
    interopCtx->inputSurfAdvConfig  = &ippCtx->inputSurfAdvConfig;
