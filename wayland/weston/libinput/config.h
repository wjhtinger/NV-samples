...
/* "libinput major version number" */
#define LIBINPUT_VERSION_MAJOR 1

/* "libinput micro version number" */
#define LIBINPUT_VERSION_MICRO 0

/* "libinput minor version number" */
#define LIBINPUT_VERSION_MINOR 5
...
#define PACKAGE_BUGREPORT "https://bugs.freedesktop.org/enter_bug.cgi?product=Wayland&component=libinput&version=1.5.0"

/* Define to the full name of this package. */
#define PACKAGE_NAME "libinput"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "libinput 1.5.0"
...
/* noop static_assert() replacement */
/* #undef static_assert */
